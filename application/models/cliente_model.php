    ...
    function borrar($tipo, $id_asociado)
    {
        switch ($tipo) {
            case 'actualizacion_campos_empresa':
                ...
                if ($this->db->delete('actualizacion_campos_empresa', array(
                    'id_empresa' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
                }
            ...
            case 'beneficiarios':
                ...
                if ($this->db->delete('asociados_beneficiarios', array(
            ...
            case 'campana':
                ...
                if ($this->db->delete('clientes_campanas', array(
                    'intCodigo' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
                }
            ...
            case 'cargos':
                ...
                if ($this->db->delete('asociados_cargos', array(
                    'id_Asociado' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
            ...
            case 'conocidos':
                ...
                if ($this->db->delete('asociados_conocidos', array(
                    'id_Asociado' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
            ...
            case 'comentario':
                ...
                if ($this->db->delete('cliente_comentarios', array(
                    'intCodigo' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
            ...
            case 'gustos':
                ...
                if ($this->db->delete('asociados_gustos', array(
                    'int_IdAsociado' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
                }
            ...
            case 'hijos':
                // Si se borran los gustos asociados al usuario
                if ($this->db->delete('asociados_hijos', array(
                    'id_Asociado' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
            ...
            case 'oportunidad':
                // Si se borran el comentario
                if ($this->db->delete('oportunidad_x_cliente', array(
                    'intCodigo' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
            ...
            case 'producto':
                // Si se borran el comentario
                if ($this->db->delete('clientes_productos', array(
                    'intCodigo' => $id_asociado
                ))) {
                    // Se retorna true
                    return true;
        ...
        switch ($numero) {
            ...
            case '3':
                ...
                if ($resultado->Compras > $resultado->Salario_Requerido) {
                    ...
                    return array(
                        'aplica' => '1',
                        'Salario_Requerido' => number_format($resultado->Salario_Requerido, 0, '', '.'),
                        'Compras' => number_format($resultado->Compras, 0, '', '.')
                    );
                } else {
                    // Se devuelve un arreglo con los datos
                    return array(
